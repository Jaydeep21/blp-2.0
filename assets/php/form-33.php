 <?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	function escape ( $string ) {
		...
		$q1 = "insert into form3 (patient_name,clinic_id,study_no,date,staff_name,current_reaction_status,nfa_3,new_nfi_3,Add1,eess_3,qol_3,vas_for_pig_3,rand_date,drug_dose_predni,drug_dura_predni,drug_dose_clofa,drug_dura_clofa,advise_ad,assessment_date,prednisolone_review) 
		values ('$patient_name','$clinic_id','$study_no','$date','$staff_name','$current_reaction_status','$nfa_3','$new_nfi_3','$Add1','$eess_3','$qol_3','$vas_for_pig_3','$rand_date','$drug_dose_predni','$drug_dura_predni','$drug_dose_clofa','$drug_dura_clofa','$advise_ad','$assessment_date','$prednisolone_review');";
		echo $q1;
