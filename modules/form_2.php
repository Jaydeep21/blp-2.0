                ...
                <!-- <fieldset> -->
                    ...
                    <div class="form-row" style="padding-left: 76px ;margin-top: 9px;">
                        ...
                        <div class="form-radio" style="padding-left: 34px">
                            ...
                            <div class="form-radio-item">                                               
                                <input type="checkbox" class = "get_value1" name="current_anti_reaction" value="Prednisolone" id="Prednisolone"/>
                                <label style="width:115px;"for="Prednisolone">Prednisolone</label>
                                <input type="checkbox"  class = "get_value1" name="current_anti_reaction" value="Clofazmine" id="Clofazmine"/>
                                <label style="width:115px;"for="Clofazmine">Clofazmine</label>            
                                <input type="checkbox"  class = "get_value1" name="current_anti_reaction" value="Thalidamide" id="Thalidamide"/>
                          ...
                          <!-- <form>-->
                                ...
                                <div class="row">
                                  ...
                                  <div class="row">
                                    ...
                                    <label class="checkbox-inline"style="padding-left:4px">
                                        <input type="checkbox" class="get_value" value="TruncalObesity"style="padding-left:4px">Truncal Obesity  
                                    </label>
                                    <label class="checkbox-inline"style="padding-left:4px">
