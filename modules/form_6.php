...
<body>
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <form method="POST" id="signup-form" class="signup-form" action="../assets/php/form-66.php" enctype="multipart/form-data">
...
<div class="form-group">
  ...
  <div class="row" >
    <label class="checkbox-inline"style="padding-left:4px">
      <input type="checkbox" class="get_value2" value="ProtocolViolation"style="padding-left:8px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Protocol Violation 
    </label>
    <label class="checkbox-inline"style="padding-left:4px">
      <input type="checkbox" class="get_value2" value="PatientRefusedFollowup"style="padding-left:8px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Patient refused followup
    </label>
	<label class="checkbox-inline"style="padding-left:4px">
      <input type="checkbox" class="get_value2" value="UncontrolledReaction"style="padding-left:8px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Uncontrolled reaction
    </label>
	</div>
	<div class="row">
     <label class="checkbox-inline"style="padding-left:4px">
      <input type="checkbox" class="get_value2" value="SevereAdverseEffects"style="padding-left:8px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Severe adverse effects
    </label>
     <label class="checkbox-inline"style="padding-left:4px">
      <input type="checkbox" class="get_value2" value="Died"style="padding-left:8px">Died
    </label>
	<label for="chkpassport" class="checkbox-inline"style="padding-left:4px">
	<input type="checkbox" class="get_value2" value="Others"id="chkpassport" onclick="ShowHideDiv(this)"style="padding-left:30px" />Others
	</label>
	<hr/>
